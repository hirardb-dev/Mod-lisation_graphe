...
public class Tachedebut extends Tache {
    Tachedebut(){setnom("Debut");setduree(0);setpos(100, 450);this.Listearc = new ArrayList<>(); setColor(Color.BLUE);}
    ...
    protected Color geColor(){return this.col;}
